...
with dpg.window(tag="Primary Window"):
    dpg.add_3d_slider(label="3D Slider", default_value=[0.4147, 0.1914, 0.6184], min_x=-0.6, max_x=0.6, min_y=-0.55, max_y=0.55, min_z=0.1, max_z=0.75, height=200, width=200, callback=callbackSlider, user_data="slider")
